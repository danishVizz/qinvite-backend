...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><?=$event?> user</h1>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header"><?=$event?> user</div>
            <div class="card-body">
                <?php 
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="<?=$user_idCard?>" name="user_idCard" id="inputid" type="text" placeholder="Enter your ID card number">
                    </div>
                    <!-- Form Row-->
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" value="<?=$user_fname?>" name="user_fname" id="inputFirstName" type="text" placeholder="Enter your first name">
                        </div>
                        <!-- Form Group (last name)-->
                        <div class="form-group col-md-6">
                            <label class="small mb-1" for="inputLastName">Last name</label>
                            <input class="form-control" name="user_lname" id="inputLastName" type="text" placeholder="Enter your last name" value="<?=$user_lname?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" id="inputEmailAddress" type="email" placeholder="Enter email address" name="user_email" value="<?=$user_email?>">
                        </div>
                        <div class="form-group col-md-6">
                        <label class="small mb-1" for="user-role">User role </label>
                            <select class="form-control" name="user_role" id="user-role">
                                ...
                                <option <?php echo ($role==1) ? "selected" : "" ?> value="1">Assistant</option>
                                <option <?php echo ($role==2) ? "selected" : "" ?> value="2">Host</option>
                                <option <?php echo ($role==3) ? "selected" : "" ?> value="3">Receptionist Admin</option>
                                <option <?php echo ($role==4) ? "selected" : "" ?> value="4">Receptionist</option>
                                <option <?php echo ($role==5) ? "selected" : "" ?> value="5">Designer</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" id="inputPhone" name="user_phone" type="tel" placeholder="Enter your phone number" value="<?=$user_phone?>">
                        </div>
                        <!-- Form Group (birthday)-->
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" id="inputCity" type="text" placeholder="City" name="user_city" value="<?=$user_city?>">
                        </div>
                        <!-- Form Group (birthday)-->
                        <div class="form-group col-md-6">
