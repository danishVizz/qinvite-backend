<?php
    ...
    $events = (isset($designer->event_details) ? $designer->event_details : "");
    // echo '<pre>'; print_r($designer); exit;
?>

    <div class="card my-5 shadow">
        <div class="card-header"><h2 class="text-primary">Designer Details</h2></div>
        <div class="card-body">
            <div class="row align-items-center">
                    ...
                    <div class="card  border-0 shadow text-dark">
                        ...
                        <div class="card-body">
                            <div class="recp_bio p-4">
                                <p><b>Name:</b>  <?= $designer->first_name .' '. $designer->last_name?></p>
                                <p><b>ID card:</b>  <?= $designer->username ?></p>
                ...
                <div class="col-md-6 col-sm-12">
                    <?php if($designer->user_image){ ?>
                        <img height="300px" width="300px" class="rounded-circle d-block mx-auto" src="<?=base_url()?>images/user_img/<?=$designer->user_img?>" alt="Profile Image">
                    <?php }else{ ?>
